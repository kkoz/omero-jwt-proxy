#!/usr/bin/env python
# Author: Kevin Kozlowski <kevin(at)glencoesoftware(dot)com>,
#
# Version: 0.1
...
DESCRIPTION = "OMERO JWT authentication proxy app"
AUTHOR = "Glencoe Software"
#LICENSE = "AGPL-3.0"
#HOMEPAGE = "https://github.com/ome/omero-jwt-proxy"
...
#      license=LICENSE,
#      url=HOMEPAGE,
      keywords=['OMERO.web', 'jwt', 'proxy'],
      install_requires=['django', 'pyjwt>=1.6.4', 'requests>=2.19.1', 'cryptography>=2.3.1'],
